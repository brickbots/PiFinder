...
configurations in the v2.5 directory.  If you have purchased a kit or ordered PCB's and parts
from the BOM, this is the version you are building.

The v2.5 is functionally identical to the v3, runs the 
...
Case parts and PCB designs for the v3 are available here for reference, but there is no build 
guide and we can't support DIY v3 builds as the electronics MUST be assembled
via reflow soldering and are not able to be built by hand.  If you've
ordered a kit or otherwise hand-assembled your electronics, you'll want to follow the v2.5 build
guide and print the v2.5 parts.
