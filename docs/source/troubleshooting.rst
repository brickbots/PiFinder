...
At the wrong baud rate the GPS never locks, no matter how long you wait.  From the main
menu, select Settings, scroll down to Advanced, select GPS Settings, then select GPS Baud
Rate.
