...
def main():
    ...
    parser.add_argument('--mode', choices=['record', 'replay', 'test', 'sample'],
    ...
    if args.mode == 'record':
        ...
        if recorded_file:
            ...
            logger.info(f"To replay: python {sys.argv[0]} --mode replay --file {recorded_file}")
        ...
        logger.info(f"To replay: python {sys.argv[0]} --mode replay --file {sample_file}")
