...
class UILog(UIModule):
    ...
    def update(self, force=False):
        ...
        if self.modal_text:
            ...
            self.draw.text((0, 50), padded_text, font=self.font_large, fill=self.colors.get(255))
            return self.screen_update()

        if not self.shared_state.solve_state():
            self.draw.text((0, 20), "No Solve Yet", font=self.font_large, fill=self.colors.get(255))
            return self.screen_update()
        ...
        self.draw.text((0, 40), object_text, font=self.font_bold, fill=self.colors.get(128))

        # Notes Prompt
        self.draw.text(
            (15, 100), "Hold A for notes", font=self.font_base, fill=self.colors.get(128)
        )
        ...
        self.draw.text((5, 75), f"from target", font=self.font_bold, fill=self.colors.get(128))
        ...
        self.draw.text((10, 117), "Log", font=self.font_small, fill=self.colors.get(128))
        ...
        self.draw.text((54, 117), "Photo", font=self.font_small, fill=self.colors.get(128))
        ...
        self.draw.text((98, 117), "Abort", font=self.font_small, fill=self.colors.get(128))
