    ...
    def get_image(
        ...
        **kwargs,
        ...
        if burn_in:
            ...
            # NSEW labels + object size box (image_nsew / image_bbox settings).
            # Drawn on the field image before padding, matching the orientation
            # (image_rotate + flip/flop) the POSS image was rendered with.
            fx = -1 if (telescope and telescope.flop_image) else 1
            fy = -1 if (telescope and telescope.flip_image) else 1
            return_image = add_orientation_overlays(
                return_image,
                display_class,
                catalog_object,
                fov,
