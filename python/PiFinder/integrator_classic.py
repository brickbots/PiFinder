...
# -*- coding:utf-8 -*-
"""
This module is the classic integrator using euler-angle/alt-az IMU
dead-reckoning.

* Checks IMU
* Uses alt/az euler angle offsets from IMU for dead-reckoning
* Converts back to RA/Dec via altaz_to_radec
